...
# Set MCR directory
if [ -d "${TMPDIR}/mcr/stopgap_${procnum}" ]; then
    rm -rf ${TMPDIR}/mcr/stopgap_${procnum}
fi
mkdir -p ${TMPDIR}/mcr/stopgap_${procnum}
export MCR_CACHE_ROOT="${TMPDIR}/mcr/stopgap_${procnum}"
